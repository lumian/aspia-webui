-- --------------------------------------------------------
-- Хост:                         127.0.0.1
-- Версия сервера:               10.3.36-MariaDB-0+deb10u2 - Debian 10
...
-- Дамп структуры для таблица kc_aspia_new.installers_data
...
-- Дамп структуры для таблица kc_aspia_new.packages_data
...
-- Дамп структуры для таблица kc_aspia_new.sessions
